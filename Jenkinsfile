        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Drewpl2021/SysAlmacen.git'
                }
            }
        }
        stage('Build') {
